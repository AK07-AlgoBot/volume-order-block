...
GROWW_DAILY_PNL_KEY_TEMPLATE: Final[str] = "ak07:groww_daily_pnl:{username}"
...
BREAKOUT_OPEN_TICK_KEY_TEMPLATE: Final[str] = "ak07:breakout_open_tick:{day}:{index}"
...
COPY_KITE_STATE_KEY: Final[str] = "ak07:copy_kite_state"
...
OFTRAP_TRADE_KEY: Final[str] = "ak07:oftrap_trade"
